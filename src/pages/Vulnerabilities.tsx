      ...
      <div className="space-y-4">
        {loading ? (
          ...
          <motion.div
            ...
            className="p-5 border border-gold/20 bg-black/40 backdrop-blur-md rounded-xl flex items-center justify-between group hover:border-red-500/40 transition-colors"
          >
