...
export default function CertificateTelemetryPage() {
  const telemetry = useRealtimeStream('Certificate Telemetry');
        ...
        >
          <div>
            ...
            <p className="text-[#FFD36B]/60 mt-2 text-sm tracking-wide">
              Detailed tracking of certificate lifecycles and usage.
            </p>
          </div>
