...
export default function MigrationSandboxPage() {
  const telemetry = useRealtimeStream('Migration Sandbox');
        ...
        >
          <div>
            ...
            <p className="text-[#FFD36B]/60 mt-2 text-sm tracking-wide">
              Safe environment to test quantum-safe cryptographic migrations.
            </p>
          </div>
