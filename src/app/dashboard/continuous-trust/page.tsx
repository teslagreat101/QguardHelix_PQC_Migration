...
export default function ContinuousTrustPage() {
  const telemetry = useRealtimeStream('Continuous Trust Validation');
        ...
        >
          <div>
            ...
            <p className="text-[#FFD36B]/60 mt-2 text-sm tracking-wide">
              Ongoing validation of cryptographic trust chains.
            </p>
          </div>
