...
export default function RuntimeCryptoIntelPage() {
  const telemetry = useRealtimeStream('Runtime Cryptographic Intelligence');
        ...
        >
          <div>
            ...
            <p className="text-[#FFD36B]/60 mt-2 text-sm tracking-wide">
              Live intelligence gathering on cryptographic operations.
            </p>
          </div>
