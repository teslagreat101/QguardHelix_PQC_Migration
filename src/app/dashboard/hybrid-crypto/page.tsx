...
export default function HybridCryptoManagerPage() {
  const telemetry = useRealtimeStream('Hybrid Crypto Manager');
        ...
        >
          <div>
            ...
            <p className="text-[#FFD36B]/60 mt-2 text-sm tracking-wide">
              Manage hybrid post-quantum and classical cryptographic deployments.
            </p>
          </div>
