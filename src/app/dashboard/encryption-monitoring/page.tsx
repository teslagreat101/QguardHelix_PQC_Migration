...
export default function EncryptionMonitoringPage() {
  const telemetry = useRealtimeStream('Encryption Monitoring');
        ...
        >
          <div>
            ...
            <p className="text-[#FFD36B]/60 mt-2 text-sm tracking-wide">
              Continuous monitoring of encryption status across assets.
            </p>
          </div>
