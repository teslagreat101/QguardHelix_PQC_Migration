        ...
        <section id="roadmap" className="py-32 px-6 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { step: "01", title: "The New Gold Standards", desc: "NIST has finalized ML-KEM, ML-DSA, and SLH-DSA for immediate global adoption.", icon: FileCheck },
                { step: "02", title: "Harvest Now, Decrypt Later", desc: "Understand why data captured today is the biggest liability for national security.", icon: Skull },
                { step: "03", title: "A Ten-Year Countdown", desc: "Experts predict quantum superiority over RSA-2048 within the next decade.", icon: Clock },
                { step: "04", title: "End Denial, Start Inventory", desc: "Identify every cryptographic endpoint in your infrastructure today.", icon: Database }
              ].map((card, i) => (
                <motion.div 
                  key={i}
