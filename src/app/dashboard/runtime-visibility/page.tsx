...
export default function RuntimeVisibilityPage() {
  const telemetry = useRealtimeStream('Runtime Visibility');
        ...
        >
          <div>
            ...
            <p className="text-[#FFD36B]/60 mt-2 text-sm tracking-wide">
              Complete observability of runtime cryptographic operations.
            </p>
          </div>
