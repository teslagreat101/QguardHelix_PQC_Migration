...
export default function TelemetryCorrelationPage() {
  const telemetry = useRealtimeStream('Telemetry Correlation');
        ...
        >
          <div>
            ...
            <p className="text-[#FFD36B]/60 mt-2 text-sm tracking-wide">
              Correlate telemetry data across multiple cryptographic endpoints.
            </p>
          </div>
