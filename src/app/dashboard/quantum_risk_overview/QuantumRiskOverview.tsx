  ...
  return (
    <div className="p-6 lg:p-8 space-y-6 min-h-screen">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          ...
          <motion.div
            ...
            className="relative overflow-hidden rounded-xl border border-gold/15 bg-black/50 backdrop-blur-xl p-5 group hover:border-gold/40 transition-all duration-500"
          >
      ...
      <div className="grid lg:grid-cols-5 gap-6">
        ...
        {/* Attack Graph */}
        <div className="lg:col-span-3 rounded-xl border border-gold/15 bg-black/50 backdrop-blur-xl p-6 relative overflow-hidden">
          ...
          <div className="relative z-10 h-[340px] rounded-lg border border-gold/10 bg-black/30 overflow-hidden">
