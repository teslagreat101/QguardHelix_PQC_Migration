...
export default function PqcOrchestrationPage() {
  const telemetry = useRealtimeStream('PQC Orchestration');
        ...
        >
          <div>
            ...
            <p className="text-[#FFD36B]/60 mt-2 text-sm tracking-wide">
              Centralized orchestration for Post-Quantum Cryptography.
            </p>
          </div>
