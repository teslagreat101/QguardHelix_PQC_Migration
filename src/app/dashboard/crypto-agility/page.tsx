...
export default function CryptoAgilityEnginePage() {
  const telemetry = useRealtimeStream('Crypto-Agility Engine');
        ...
        >
          <div>
            ...
            <p className="text-[#FFD36B]/60 mt-2 text-sm tracking-wide">
              Automated cryptographic transitions and agility enforcement.
            </p>
          </div>
