...
const NAV_SECTIONS = [
  ...
  },
  {
    ...
    collapsible: true,
    items: [
      { name: 'Quantum QRNG', path: '/dashboard/quantum-qrng', icon: Cpu },
      { name: 'Encryption Services', path: '/dashboard/encryption', icon: Lock },
      { name: 'Security Authentication', path: '/dashboard/auth-sec', icon: Fingerprint },
      { name: 'Digital Certificates', path: '/dashboard/certificates', icon: Award },
      { name: 'Tokenization', path: '/dashboard/tokenization', icon: Coins },
      { name: 'Secure Communications', path: '/dashboard/communications', icon: MessageSquareLock },
      { name: 'Cloud Security', path: '/dashboard/cloud-security', icon: Cloud },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Crypto Exposure', path: '/dashboard/exposure-map', icon: Globe },
  ...
  },
  {
    label: 'Operations',
    items: [
      { name: 'Migration Timeline', path: '/dashboard/timeline', icon: Clock },
      { name: 'Live Migration Ops', path: '/dashboard/live-ops', icon: Rocket },
      { name: 'Migration Terminal', path: '/dashboard/migrations', icon: Terminal },
    ],
  },
  {
    label: 'Intelligence',
