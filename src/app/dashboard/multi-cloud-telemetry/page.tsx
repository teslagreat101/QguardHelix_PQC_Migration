...
export default function MultiCloudTelemetryPage() {
  const telemetry = useRealtimeStream('Multi-Cloud Telemetry');
        ...
        >
          <div>
            ...
            <p className="text-[#FFD36B]/60 mt-2 text-sm tracking-wide">
              Unified telemetry across multi-cloud cryptographic deployments.
            </p>
          </div>
